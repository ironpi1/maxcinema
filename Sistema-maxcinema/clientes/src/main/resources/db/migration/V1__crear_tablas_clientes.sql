...
CREATE TABLE clientes(
    ...
    tipo_cliente_id INT, 
    CONSTRAINT fk_clientes_tipocliente FOREIGN KEY (tipo_cliente_id) REFERENCES tipo_cliente(id)
);
...
CREATE TABLE entradas(
    ...
    CONSTRAINT fk_entradas_pago FOREIGN KEY (metodo_pago_id) REFERENCES metodo_pago(id)
);
