...
import com.maxcinema.maxcinema.service.MetodoPagoService;
...
public class MetodoPagoController {
    ...
    @GetMapping
    public ResponseEntity<List<MetodoPagoDTO>> todosLosMetodosDePago() {
    ...
    public ResponseEntity<MetodoPagoDTO> buscarPorId(@PathVariable Integer id) {
        try {
            MetodoPagoDTO metodo = metodoPagoService.buscarPorId(id);
